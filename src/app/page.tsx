    ...
    <div className={styles.page}>
      ...
      <nav className={styles.nav}>
        <div className={styles.brand}>
          ...
          <span style={{ marginLeft: 8, fontWeight: 700 }}>Aegis</span>
        </div>
      ...
      <header className={styles.hero}>
        <h1 className={styles.heroTitle}>
          Private
          <br />
          <span className={styles.heroAccent}>Subscriptions</span>
        </h1>
        <p className={styles.heroSub}>
          Shield funds and pay recurring subscriptions on Starknet — payer
          identity and amount stay private via the STRK20 pool.
        </p>
      </header>
